...
efisien untuk menilai keterampilan pelajar secara empiris \autocite{Minn2022}. Penilaian
pelajar adalah salah satu momen utama dalam proses pendidikan.
...
seorang pelajar, agar sesuai dengan situasi dan keadaan yang berbeda. Tujuan dari
...
kebutuhan dan perilaku pelajar. Pembelajaran adaptif memberikan kemungkinan
untuk menjadikan pelajar sebagai kolaborator dalam proses pendidikan
alih-alih penerima informasi pasif, karena setiap pelajar memiliki jalur
...
Pembelajaran adaptif mempertimbangkan banyak aspek, seperti tingkat pelajar saat
ini, kebutuhan individu, gaya belajar, dan interaksi yang berbeda dengan pelajar untuk
...
pelajar untuk maju ke materi yang lebih menantang berdasarkan kinerjanya, sambil di
sisi lain tetap memberikan dukungan tambahan kepada pelajar lainnya untuk menguasai
keterampilan tertentu. Pendekatan ini memastikan bahwa pelajar tidak dibatasi
oleh kecepatan kelas tetapi dapat mengikuti kecepatan belajar mereka sendiri.
Dengan demikian, instruktur dan pelajar dapat membuat keputusan yang tepat
...
pengalaman pendidikan untuk membantu pelajar mencapai tujuan pembelajaran mereka
...
pada asesmen daripada konten. Data asesmen yang dikumpulkan dari respons pelajar
...
Dengan demikian, asesmen pelajar dianggap sebagai faktor krusial untuk proses
...
oleh pelajar \autocite{Halkiopoulos2024}. Asesmen adaptif menyediakan tes
...
mudah kepada pelajar yang mampu, yang kemungkinan akan menjawab dengan benar, dan
pertanyaan menantang tidak disajikan kepada pelajar yang kesulitan \autocite{Ihichr2024}.
...
\begin{enumerate}
    ...
    pencapaian pelajar dan memverifikasi penguasaan unit kurikulum. Asesmen ini
    ...
    \item Asesmen formatif atau yang disebut juga asesmen untuk pembelajaran \linebreak
    (\textit{assessment for learning}), ini terjadi sepanjang siklus pembelajaran
    untuk memberikan informasi umpan balik kepada tutor dan pelajar untuk membantu
    ...
    asesmen dan pembelajaran benar-benar kabur dan tidak terlihat oleh pelajar, konsep
    ...
    pelajar untuk menguasai suatu materi pembelajaran dan mengembangkan disiplin dalam
    dirinya \autocite{Ihichr2024}.
    
    % \subsubsection{Pra-Asesmen}
    \item Praasesmen atau yang dikenal sebagai asesmen diagnostik, jenis asesmen ini
    mengukur kompetensi awal setiap pelajar, memberikan gambaran yang jelas kepada
    guru tentang tingkat keterampilan pelajar. Ini sering kali diikuti oleh semacam
    instruksi kompensasi untuk menghilangkan hambatan dan menawarkan berbagai jenis
    kegiatan remedial. Praasesmen biasanya dilakukan di awal pembelajaran dan dirancang
    untuk mengukur pengetahuan yang sudah diperoleh sebelumnya oleh pelajar untuk
    mengidentifikasi kebutuhan, kompetensi, prasangka, dan pengetahuan sebelumnya
    dari pelajar tersebut, untuk mengarahkan mereka ke kurikulum yang paling sesuai
    \autocite{Ihichr2024}.
\end{enumerate}
...
Integrasi kata kerja komputasi ini memungkinkan perancangan \textit{competencies} yang lebih akurat, yang didefinisikan sebagai integrasi antara pengetahuan (\textit{knowledge}), keterampilan (\textit{skills}), dan disposisi (\textit{dispositions}) dalam konteks tertentu \autocite{ACM2023}. Dalam lingkungan pembelajaran adaptif, pemetaan ini krusial untuk melacak progresi pelajar. Seorang pelajar mungkin memulai pembelajaran pada level \textit{Applying} dengan menerjemahkan spesifikasi menjadi kode, namun seiring waktu diharapkan berkembang ke level \textit{Creating} dengan mengimplementasikan solusi untuk masalah abstrak. \textcite{ACM2023} juga menyoroti bahwa disposisi atau aspek sikap (seperti \textit{collaborative} dan \textit{meticulous}) dapat dikaitkan dengan kompetensi teknis tersebut. Dengan demikian, sistem asesmen tidak hanya melacak kebenaran sintaksis kode, tetapi juga kedalaman pemahaman konseptual dan kemampuan kolaboratif pelajar berdasarkan hierarki kognitif yang terstandarisasi.
...
langsung, namun keberadaannya dianggap menentukan hasil atau kinerja pelajar pada
suatu tugas. Dalam kerangka kerja psikometri,
pemetaan antara \textit{item} (pertanyaan) dan KCs yang diperlukannya sering kali
...
pelajar atas KCs yang tersembunyi ini.
...
pelajar, \textit{self-regulated learning} (pembelajaran mandiri),
transparansi personalisasi, dan motivasi pelajar
...
Hal ini dicapai dengan mengizinkan pelajar untuk mengeksplorasi model-model
rekan pelajar dan/atau model kelas yang diagregasi. Pendekatan ini memiliki
...
meningkatkan motivasi dan keterlibatan pelajar. Penelitian telah menunjukkan
...
kompetensi pelajar dan tingkat kesulitan konten pendidikan \autocite{Vesin2022}. 
...
karena mengasumsikan pelajar tidak belajar selama proses pengujian; ini dianggap 
...
setiap pelajar setelah satu respons untuk satu tugas \autocite{Vesin2022}.
...
Model berbasis FA memperkirakan kemahiran pelajar pada setiap
...
respons pelajar. Dalam CFA, peneliti perlu menentukan
...
pelajar disimpulkan pada setiap langkah waktu berdasarkan urutan hasil sebelumnya. 
BKT mengandalkan model Markov untuk menyimpulkan keadaan penguasaan, dari belum 
dipelajari menjadi sudah dipelajari. Berbagai ekstensi BKT telah diperkenalkan, seperti 
memperhitungkan pengetahuan sebelumnya pelajar atau kesulitan \textit{item} 
\autocite{Minn2022}.
...
untuk memodelkan pembelajaran pelajar dan melacak pengetahuan mereka, digunakan untuk
...
sesuai untuk pelajar \autocite{Ihichr2024}.
...
yang memungkinkan model untuk mempelajari keadaan pengetahuan pelajar dari data. Namun,
seperti model \textit{deep learning} lainnya, DKT sering kali berfungsi sebagai 
...
jawaban pelajar. Terakhir, algoritma \textit{Elo rating} dapat memberikan estimasi
...
pelajar dengan sumber belajar. Perbedaan peringkat antara pelajar dan \textit{item}
...
berdasarkan performa pelajar pada materi pembelajaran dibandingkan nilai ekspektasinya dan (2)
tingkat kesulitan konten pembelajaran diperbarui berdasarkan tingkat pemahaman pelajar yang berhasil,
ataupun gagal dalam latihan. Secara matematis, cara ini mengestimasi probabilitas seorang pelajar \textit{i} mampu
selesaikan latihan \textit{j} berdasarkan peringkat pelajar saat ini dan tingkat kesulitan latihan \textit{j}.
...
Berbagai teknik yang telah dibahas di atas (IRT, \textit{Elo rating}, dll.) umumnya
...
\subsection{Karakteristik Ukuran Bank Soal dalam Implementasi Asesmen Adaptif Skala Kelas}
...
Untuk memberikan makna interpretatif pada nilai numerik $d$, \textcite{Cohen1988} menetapkan standard konvensi yang telah menjadi rujukan universal dalam analisis kuantitatif. Konvensi ini dirancang untuk memetakan besaran statistik ke dalam dampak kualitatif yang dapat diamati di dunia nyata.
\begin{enumerate}
...
\end{enumerate}
standard operasional ini memberikan landasan teoretis yang kokoh untuk menetapkan ambang batas (\textit{threshold}) dalam menentukan apakah dua entitas (atau kelompok) dapat dikategorikan "berbeda secara signifikan" atau heterogen dalam konteks intervensi pendidikan.
...
\begin{enumerate}
    ...
    pelajar saling menilai pekerjaan rekannya, artinya dalam
    ...
    berpusat pada pelajar, dengan tujuan "menghasilkan sebuah karya proyek yang
    ...
    pelajar". Keberhasilan ini diatribusikan pada
...
\autocite{Ihichr2024}. Studi oleh \textcite{Ihichr2024} mencatat bahwa pelajar mendapat
...
\textit{Overpersonalization} ini dapat menjadi penghalang ketika pelajar seharusnya mampu memperoleh manfaat dari aspek komunal pembelajaran. Oleh karena itu,
...
dapat menciptakan situasi yang menyebabkan pelajar yang seharusnya bisa
...
kolaboratif, tetapi sering kali secara terpisah dari \textit{loop} asesmen adaptif
...
eksplorasi sosial ini dapat meningkatkan pembelajaran, terutama bagi pelajar
...
\textit{output} untuk memotivasi pelajar, namun tidak merinci bagaimana data
...
Pendekatan ini sangat relevan untuk konteks pembelajaran adaptif karena "pengguna sensitif" dapat dipetakan sebagai pelajar yang terisolasi secara akademik, dan "favorable items" sebagai interaksi dengan rekan yang memiliki kompetensi berbeda (heterogen).
...
Implementasi asesmen adaptif dalam lingkungan digital memerlukan strategi desain instrumen yang tidak hanya mengandalkan algoritma, tetapi juga mempertimbangkan mekanisme interaksi pelajar dengan soal untuk mendukung tujuan pembelajaran formatif. Bagian ini membahas landasan teoretis mengenai penggunaan kuis daring yang mengintegrasikan fitur percobaan berulang dan sistem umpan balik otomatis sebagai upaya untuk meningkatkan pemahaman konsep secara mandiri.
...
Integrasi sistem umpan balik otomatis dalam kuis daring merupakan elemen krusial untuk mengatasi keterbatasan instruktur dalam memberikan koreksi secara instan dan berkelanjutan pada kelas dengan jumlah pelajar yang besar. \textcite{Mendoza2022} menyatakan bahwa umpan balik yang diberikan secara tepat waktu, spesifik, dan berkelanjutan sangat penting untuk memperbaiki kesalahan serta kekeliruan pelajar selama proses asesmen berlangsung agar tidak terulang kembali. Penggunaan teknologi digital dalam penyampaian umpan balik berpotensi meningkatkan kualitas respons serta menghemat waktu pemeriksaan bagi pengajar dibandingkan dengan metode tertulis tradisional. Umpan balik yang efektif harus memiliki karakteristik yang mudah dipahami, selektif, spesifik, tepat waktu, kontekstual, dan berorientasi ke depan agar dapat memicu tindakan perbaikan lebih lanjut dari sisi pelajar. Selain itu, umpan balik elektronik dapat mengurangi hambatan logistik sambil tetap mempertahankan fitur-fitur terbaik dari umpan balik tradisional yang bersifat jelas dan komprehensif bagi penerimanya.

Dampak dari sistem umpan balik otomatis ini tercermin pada persepsi positif pelajar yang menganggapnya sebagai panduan yang berguna dalam memahami materi pembelajaran meskipun tanpa kehadiran fisik instruktur secara langsung. Berdasarkan temuan \textcite{Mendoza2022}, mayoritas pelajar merasa terbantu dalam mengidentifikasi aspek materi yang belum dikuasai serta keterampilan spesifik yang perlu mereka tingkatkan melalui pesan koreksi yang muncul setelah setiap jawaban diberikan. Umpan balik yang dirancang dengan mempertimbangkan alasan masuk akal dari pilihan jawaban salah (\textit{plausible distractors}) memungkinkan pelajar untuk melakukan komputasi ulang dan mengingat kembali konsep yang telah diajarkan sebelumnya. Penting untuk dicatat bahwa umpan balik dalam sistem ini idealnya bersifat menyarankan (\textit{suggestive}) dan bukan memerintah (\textit{prescriptive}), sehingga pelajar tetap memiliki otonomi dan kebebasan dalam menentukan cara pemecahan masalah sesuai preferensi mereka sendiri. Dengan demikian, ketersediaan umpan balik yang instan bersamaan dengan fitur percobaan berulang menciptakan ruang interaksi yang bermakna antara pelajar dan sistem untuk meminimalkan stagnasi pembelajaran.
