...
\begin{center}
    ...
    {\Large\bfseries\uppercase{IMPLEMENTASI PURWARUPA SISTEM ASESMEN ADAPTIF KOLABORATIF BERBASIS \textit{ELO RATING} DENGAN MITIGASI \textit{OVERPERSONALIZATION}}}\\
     \vspace{4cm}
