...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.20\textwidth}|p{0.70\textwidth}|}
        ...
        \hline
        \textbf{Deskripsi} & pemelajar mengevaluasi pekerjaan rekan sejawat menggunakan rubrik terstruktur. Aktivitas ini dipicu oleh sistem untuk memecahkan isolasi kompetensi. \\
        \hline
        ...
        \textbf{Main Flow} & \begin{enumerate}[noitemsep,topsep=0pt,leftmargin=*]
            \item pemelajar menerima notifikasi tugas \textit{peer-assessment}.
            \item Sistem menampilkan jawaban rekan \textbf{tanpa identitas (anonim)} beserta kolom penilaian.
            \item pemelajar mengisi penilaian.
