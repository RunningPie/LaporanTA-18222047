...
\begin{center}
    ...
    {\Large\bfseries\uppercase{IMPLEMENTASI PURWARUPA SISTEM ASESMEN ADAPTIF BERBASIS \textit{ELO RATING} DENGAN FITUR SOSIAL UNTUK MEMITIGASI \textit{OVERPERSONALIZATION}}}\\
     \vspace{4cm}
