...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.20\textwidth}|p{0.70\textwidth}|}
        ...
        \hline
        \textbf{Kondisi sebelum} & pelajar memiliki akun yang terdaftar di dalam basis data sistem. \\
        \hline
        \textbf{Kondisi sesudah} & Sesi pengguna aktif; Sistem memuat profil Elo rating pelajar. \\
        \hline
        \textbf{Main Flow} & \begin{enumerate}[noitemsep,topsep=0pt,leftmargin=*]
            \item pelajar memasukkan kredensial akun (\textit{username/password}).
