...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.20\textwidth}|p{0.70\textwidth}|}
        ...
        \hline
        \textbf{Deskripsi} & pemelajar melihat visualisasi perkembangan kemahiran individunya, termasuk kontribusi dari aktivitas individu dan sosial. \\
        \hline
        \textbf{Kondisi sebelum} & Data riwayat aktivitas pembelajaran pemelajar tersedia. \\
        \hline
        ...
        \textbf{Main Flow} & \begin{enumerate}[noitemsep,topsep=0pt,leftmargin=*]
            \item pemelajar mengakses menu profil.
            \item Sistem mengambil data skor Elo milik pemelajar.
