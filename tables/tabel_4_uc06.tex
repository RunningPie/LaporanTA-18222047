...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.20\textwidth}|p{0.70\textwidth}|}
        ...
        \hline
        \textbf{Deskripsi} & pemelajar melihat posisi relatif kemahirannya dibandingkan dengan distribusi kemampuan kelas secara anonim (\textit{Social Awareness}). \\
        \hline
        ...
        \textbf{Main Flow} & \begin{enumerate}[noitemsep,topsep=0pt,leftmargin=*]
            \item pemelajar mengakses menu wawasan grup/kelas.
