...
\begin{center}
    \textbf{IMPLEMENTASI PURWARUPA SISTEM ASESMEN ADAPTIF BERBASIS \textit{ELO RATING} DENGAN FITUR SOSIAL UNTUK MEMITIGASI \textit{OVERPERSONALIZATION}} \\
    \vspace{0.4cm}
    oleh \\
    \vspace{0.4cm}
