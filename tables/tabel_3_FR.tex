...
% Bagian 1
\multicolumn{2}{|l|}{\textbf{Interaksi Pengguna (pelajar)}} \\
\hline
FR-01 & Sistem harus menyediakan mekanisme otentikasi bagi pelajar untuk mengakses lingkungan pembelajaran personal mereka. \\
\hline
FR-02 & Sistem harus menyajikan konten pembelajaran yang telah disesuaikan tingkat kesulitannya dengan kemahiran pelajar saat ini. \\
\hline
...
\hline
FR-05 & Sistem harus memiliki algoritma untuk mengestimasi tingkat kemahiran pengetahuan individu pelajar secara dinamis berdasarkan riwayat aktivitasnya. \\
\hline
...
FR-06 & Sistem harus mampu mendeteksi kondisi stagnasi pembelajaran (\textit{learning plateau}) pelajar secara otomatis berdasarkan suatu metrik atau proksi. \\
\hline
FR-07 & Sistem harus mampu merekomendasikan \textbf{intervensi sosial spesifik} (misalnya, merekomendasikan orang untuk berinteraksi atau topik untuk didiskusikan) agar bisa mendorong pelajar keluar dari stagnasi pembelajaran. \\
\hline
FR-08 & Sistem harus menggunakan metrik kuantitatif untuk menentukan materi atau aktivitas berikutnya yang paling optimal bagi pelajar. \\
\hline
