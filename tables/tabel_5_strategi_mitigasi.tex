\begin{table}[H]
    ...
    \begin{tabular}{|p{0.1\textwidth}|p{0.3\textwidth}|p{0.5\textwidth}|}
        ...
        \hline
        \textbf{R-03} & pemelajar menilai terlalu murah hati/pelit (bias subjektif). & Risiko ini dimitigasi melalui dua lapis perlindungan: (1) Penerapan \textbf{\textit{Double-Blind System}} untuk mencegah bias relasional (rasa sungkan antar-teman), dan (2) Validasi skor kualitas asesmen oleh \textit{Multi-LLM Voting} yang objektif. \\
        \hline
    \end{tabular}
\end{table}