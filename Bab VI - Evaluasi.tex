...
Pengujian dilakukan menggunakan metode \textit{Two-Group Pretest-Posttest} dengan pembagian peserta ke dalam Grup A (dengan intervensi kolaboratif) dan Grup B (tanpa intervensi/kontrol). Partisipan terdiri dari 20 mahasiswa yang telah menyelesaikan mata kuliah basis data. Sesi pengujian berlangsung selama 105 menit yang mencakup tahap \textit{pre-test}, interaksi sistem (75 menit), dan \textit{post-test}.
